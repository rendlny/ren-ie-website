<?php
$config = parse_ini_file('../../php/config.ini');
$version = "9.14.0";
if (session_id() == '') {
  session_start();
}
...
$config = array(
    ...
    */
    ...
    |
    */
    'thumbs_upload_dir' => '/web/assets/thumbs/',
    ...
    */
    ...
    'access_keys' => array($config['filemanager_key']),
