<div class="ms-hero-page ms-hero-img-keyboard ms-hero-bg-info mb-6">
    ...
    <div class="col-md-12">
      ...
      <div class="card card-primary bg-dark">
        <div class="card-header">
          <h3 class="card-title"><i class="zmdi zmdi-code"></i>&nbsp; PHP</h3>
        </div>
        <div class="card-body">
          <p class="text-center">
            I have 2 years of experience using PHP with JS, Ajax, jQuery and
            phpMyAdmin to create web applications such as shop, inventory
            management, bookings & article systems. Worked on major projects with
            my team by following Scrum / Agile methodologies and the use of
            Jira Kanban boards to deliver projects in a timely and efficient
            manner.
          </p>
        </div>
      </div>
      ...
      <div class="card card-primary bg-dark">
        <div class="card-header">
          <h3 class="card-title"><i class="zmdi zmdi-language-python"></i>&nbsp; Python</h3>
        </div>
        <div class="card-body">
          <p class="text-center">
